...
//		pm.makeStackedBarChart();
	...
	public void makeLineAndShapeChart() {
		...
		createTimeXYChar("气温折线图", "时刻", "温度(摄氏度)", dataset, "lineAndShap.png");
	}
	...
	public void makeBarGroupChart() {
		...
		String[] columnKeys = { "北京2", "上海", "广州", "成都", "深圳" };
		CategoryDataset dataset = getBarData(data, rowKeys, columnKeys);
	...
	public void makeBarChart() {
		double[][] data = new double[][] { { 672, 766, 223, 540, 126 } };
		String[] rowKeys = { "苹果" };
		String[] columnKeys = { "北京1", "上海1", "广州", "成都", "深圳" };
		CategoryDataset dataset = getBarData(data, rowKeys, columnKeys);
	...
	public void makeStackedBarChart() {
		...
		String[] rowKeys = { "aaa", "bbb" };
		String[] columnKeys = { "22", "上海", "广州", "成都", "深圳" };
		CategoryDataset dataset = getBarData(data, rowKeys, columnKeys);
